...
public sealed class PresetCatalog
{
    ...
    [
        ...
        new(
            ...
            "Full",
            PresetCategory.Vocals,
            "Maximum capture, harmonies included",
            5,
            "8 GB"
        ),
        new(
            ...
            "RVC / AI",
            PresetCategory.Vocals,
            "Optimized for voice training datasets",
            3,
            "4 GB"
        ),
        new(
            ...
            "Good balance of noise and fullness",
            4,
            "6 GB"
        ),
        new(
            ...
            "Clean",
            PresetCategory.Instrumentals,
            "Cleanest output, minimal vocal residue",
            3,
            "4 GB"
        ),
        new(
            ...
            "Full",
            PresetCategory.Instrumentals,
            "Maximum instrument preservation",
            5,
            "8 GB"
        ),
        new(
