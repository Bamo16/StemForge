...
public partial class MainWindowViewModel : ViewModelBase
{
    ...
    private const string IconSeparate =
        "M3 6 L15 6 M3 9 L15 9 M3 12 L15 12";
    private const string IconQueue =
        "M3 4 H15 V6 H3 Z M3 8 H15 V10 H3 Z M3 12 H15 V14 H3 Z";
    private const string IconModels =
        "M9 2 L15 5 V13 L9 16 L3 13 V5 Z M3 5 L9 8 L15 5 M9 8 V16";
    ...
    public MainWindowViewModel()
    {
        ...
        NavItems = new ObservableCollection<NavItem>
        {
            ...
            new() { Label = "Queue",    IconData = IconQueue,    Target = queue },
